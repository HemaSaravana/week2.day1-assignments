...
public class CeateLead {
	...
	driver.findElement(By.id("createLeadForm_lastName")).sendKeys("saravana");
	...
	driver.findElement(By.id("createLeadForm_lastNameLocal")).sendKeys("Saravanakumar");
	driver.findElement(By.id("createLeadForm_birthDate")).sendKeys("08/08/93");
	driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Hemapriya");
